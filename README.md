...
See the wiki: https://github.com/paddy696/YOLOv5-Lite-Pytorch/wiki/Test-the-map-of-models-about-coco
...
[requirements.txt](https://github.com/paddy696/YOLOv5-Lite-Pytorch/blob/master/requirements.txt) installed including
[**PyTorch>=1.7**](https://pytorch.org/get-started/locally/):
<!-- $ sudo apt update && apt install -y libgl1-mesa-glx libsm6 libxext6 libxrender-dev -->

```bash
$ git clone https://github.com/paddy696/YOLOv5-Lite-Pytorch
$ cd YOLOv5-Lite-Pytorch
...
the [latest YOLOv5-Lite release](https://github.com/paddy696/YOLOv5-Lite-Pytorchreleases) and saving results to `runs/detect`.
...
Here, the original components of YOLOv5 and the reproduced components of YOLOv5-Lite are organized and stored in the [model hub](https://github.com/paddy696/YOLOv5-Lite-Pytorch/tree/master/models/hub)：
...
[**ncnn**](https://github.com/paddy696/YOLOv5-Lite-Pytorch/blob/master/cpp_demo/ncnn/README.md)  for arm-cpu

[**mnn**](https://github.com/paddy696/YOLOv5-Lite-Pytorch/blob/master/cpp_demo/mnn/README.md) for arm-cpu

[**openvino**](https://github.com/paddy696/YOLOv5-Lite-Pytorch/blob/master/python_demo/openvino/README.md) x86-cpu or x86-vpu 

[**tensorrt(C++)**](https://github.com/paddy696/YOLOv5-Lite-Pytorch/blob/master/cpp_demo/tensorrt/README.md) for arm-gpu or arm-npu or x86-gpu

[**tensorrt(Python)**](https://github.com/paddy696/YOLOv5-Lite-Pytorch/tree/master/python_demo/tensorrt) for arm-gpu or arm-npu or x86-gpu

[**Android**](https://github.com/paddy696/YOLOv5-Lite-Pytorch/blob/master/android_demo/ncnn-android-v5lite/README.md) for arm-cpu
...
link: https://github.com/paddy696/YOLOv5-Lite-Pytorch/tree/master/android_demo/ncnn-android-v5lite
